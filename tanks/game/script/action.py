class Action:
    ...
    The responsibility of action is to do something that is important in the game. Thus, it
    has one method, execute(), which should be overridden by derived classes.
    """

    def execute(self, cast, script, callback):
        """Executes something that is important in the game. This method should be overridden
        by derived classes.
