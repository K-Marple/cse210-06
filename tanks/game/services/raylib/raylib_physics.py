import pyray
from game.services.physics import Physics


class RaylibPhysics(Physics):
    """A Raylib implementation of Physics."""
    ...
    def is_left_of(self, subject, agent):
        ...
        collision_rectangle_right = collision_rectangle.x + subject_rectangle.width
